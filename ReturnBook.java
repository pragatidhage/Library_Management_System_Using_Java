...
public class ReturnBook extends JFrame implements ActionListener{
  ...
  JTextField textField_1;
   JTextField textField_2;
	...
	JLabel l1 = new JLabel("Date of Return");
	l1.setForeground(Color.BLACK);
	l1.setFont(new Font("Tahoma", Font.BOLD, 14));
	l1.setBounds(52, 234, 118, 29);
	contentPane.add(l1);
	...
	textField_t1 = new JTextField();
        textField_t1.setForeground(new Color(47, 79, 79));
        textField_t1.setFont(new Font("Trebuchet MS", Font.BOLD, 14));
        textField_t1.setBounds(167, 234, 172, 29);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        st.setString(8, textField_t1.getText()); 
		int i = st.executeUpdate();
		if (i > 0){
